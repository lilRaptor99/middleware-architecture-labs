...
public class TemperatureMonitor extends UnicastRemoteObject implements
	...
	// Create the temperature sensor object and register it with the server as a
	// listener
	public static void main(String[] args) {
		...
		try {
			...
			// Register the listener in the server object
	...
	// Server calls this method when the temperature changes
